...
tags = ["data-types"]
draft = false
aliases = ["/2026-04-11-rust-fundamentals-compound-data-types"]
+++

In the previous article on [Scalar Data Types](@/blog/2026-04-10-rust-fundamentals-scalar-data-types.md), we covered values that represent a single thing: an integer, a float, a boolean, or a character. Compound data types let you group multiple values together into one type. Rust has two built-in compound types: tuples and arrays.
