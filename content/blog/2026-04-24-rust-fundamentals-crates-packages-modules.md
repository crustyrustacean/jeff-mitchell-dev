...
draft = false
aliases = ["/2026-04-24-rust-fundamentals-crates-packages-modules"]
+++
...
This brings both `io` itself and the `Write` trait into scope in a single line. You've seen this exact line in the [greeting program](@/blog/2026-04-15-rust-building-something-a-greeting-program.md) earlier in this series.
