...
In the [enums article](@/2026-04-17-rust-fundamentals-enum-type.md), we saw that enum variants can carry data. The `match` expression is how you extract that data. Each arm can bind the inner values to variables:
