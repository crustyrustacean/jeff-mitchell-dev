...
The most explicit way to work with an `Option` is through `match`, which you'll recognize from the [previous article on pattern matching](@/2026-04-21-rust-fundamentals-match-syntax.md):
